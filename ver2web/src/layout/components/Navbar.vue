<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <span style="margin-right:30px;font-size:20px;line-height:20px">艾康防疫组</span>
      <el-dropdown class="avatar-container"
                   trigger="click">
        <div class="avatar-wrapper">
          <span style="margin-bottom:25px font-size:24px">{{user_name }}</span>
    ...
    <div>
      ...
      <el-dialog title="密码修改"
        ...
        <span slot="footer"
          ...
          <el-button type="primary"
                     @click="handleSavePassword">确 定</el-button>
        </span>
      </el-dialog>
    </div>
  </div>

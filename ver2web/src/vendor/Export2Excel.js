...
export function export_json_to_excel({
  ...
  for (var b in dataInfo) {
    // console.log(b)
    // console.log(myRowFont)
    // console.log(b.indexOf(myRowFont))
    // if (b.indexOf(myRowFont) > -1) {
    //   dataInfo[b].s = tableTitleFont
    // }
    if (b == '!ref' || b == '!merges' || b == '!cols' || b == 'A1') {
  ...
  var wbout = XLSXX.write(wb, {bookType: 'xlsx', bookSST: false, type: 'binary'});
  // var title = defaultTitle || '列表'

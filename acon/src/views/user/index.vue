        ...
        <el-table
          ...
          <!-- <el-table-column
            ...
            <template slot-scope="scope">
              <div v-if="scope.row.lastRecord !== null && scope.row.lastRecord.result !== null">
                <el-button
                  size="mini"
                  type="text"
                  style="color:#1890FF"
                  @click="handleEdit(scope.row.lastRecord.stripPath)">{{ scope.row.lastRecord.resultDisplay }}
                </el-button>
          ...
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <div v-if="scope.row.lastRecord !== null && scope.row.lastRecord.creationTime !== null">
                <span>{{ formatterTime(scope.row.lastRecord.creationTime) }}</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <div v-if="scope.row.lastRecord !== null && scope.row.lastRecord.addressDisplay !== null">
                <span>{{ scope.row.lastRecord.addressDisplay }}</span>
              </div>
            </template>
          </el-table-column> -->
          <el-table-column

<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <span style="margin-right:30px;font-size:20px;line-height:20px">{{ organizationName }}({{ departmentName }})</span>
      <el-dropdown class="avatar-container" trigger="click">
        <div class="avatar-wrapper">

          <!-- <span>
            <el-avatar icon="el-icon-user-solid" size="small" style="margin-top:15px" />
          </span> -->

          <!-- <img :src="ava5tar+'?imageView2/1/w/80/h/80'" class="user-avatar"> -->
...
export default {
  ...
  computed: {
    ...
    qrCode () {
      return this.departmentName + ',' + this.avatar
    }
  },
  created () {
    this.initData()

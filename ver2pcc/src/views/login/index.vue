  ...
  methods: {
    initData () {
      ...
      if (this.$baseConfig !== undefined && this.$baseConfig !== null) {
        if (this.$baseConfig.isShowTenant !== null && this.$baseConfig.isShowTenant !== undefined) {
          if (this.$baseConfig.isShowTenant === false) {
            this.isShowTenant = false
            this.loginForm.tenant = this.$baseConfig.tenant
          } else {
            console.log(this.$baseConfig.tenant)
